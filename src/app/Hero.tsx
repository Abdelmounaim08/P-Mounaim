...
export const Hero = () => {
  return (
    <div className="h-[88vh] bg-[url('/image/backgroung.jpg')] bg-cover bg-center">
      <Particle/> 
...
<button className='px-[2rem] hover:bg-yellow-400 transition-all duration-200 py-[1rem] text-[18px] font-bold uppercase bg-[#55e6a5]
 ...
 /><p className='text-[20px] font-semibold text-white'>watch the Video</p> </button>
   ...
   <div className='w-[480px] hidden bg-[#55e6a5] relative lg:flex items-center mt-9 rounded-full h-[480px]'>
    
   <Image src='/image/Untitled.png'
     alt='user' layout='fill' 
     className=' relative z-[11] object-contain bg-yellow-300 rounded-full'/>
