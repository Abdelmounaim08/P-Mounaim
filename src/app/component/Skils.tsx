  ...
  return (
    <div className='pt-[4rem] md:pt-[8rem] pb-[5rem] bg-[#09101a] '>
      ...
      <div className='w-[80%] mx-auto pt-[4rem] md:pt-[8rem] grid grid-cols-1 md:grid-cols-2 gap-[2rem] items-center'>
        <div >
          <SklisItems title='React Developer' year='2022-2024' text="As a trained React developer, I possess the necessary skills and experience to build dynamic and responsive user interfaces. Proficiency in JavaScript and React.js allows me to create reusable components and effectively manage state using tools like Redux or Context API. I have gained a solid understanding of React's core principles and industry best practices, enabling me to develop scalable and efficient web applications."/>
          <SklisItems title='Next JS Developer' year='2023-2024' text="As a skilled Next.js developer, I have a deep understanding of this powerful React framework and its capabilities. Next.js provides a robust and flexible platform for building high-performance, server-rendered React applications. Through my extensive experience, I have mastered the core features and functionalities of Next.js, allowing me to leverage its unique advantages."/>
