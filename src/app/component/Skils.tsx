    ...
    <div className='pt-[4rem] md:pt-[8rem] pb-[5rem] bg-[#09101a] '>
      ...
      <div className='w-[80%] mx-auto pt-[4rem] md:pt-[8rem] grid grid-cols-1 md:grid-cols-2 gap-[2rem] items-center'>
        ...
        <div>
          ...
          <SklisItems title='shpify Developer' year='2024' text="As an experienced Shopify developer, I specialize in building customized e-commerce solutions on the Shopify platform. With a deep understanding of Shopify's Liquid templating language and APIs, I can create visually appealing and fully functional online stores. Whether it's designing custom themes, integrating payment gateways, or optimizing SEO, I leverage Shopify's features to deliver seamless shopping experiences for clients."/>
